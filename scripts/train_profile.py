...
from src.mslm.utils import create_dataloaders, build_model, profile_training, prepare_datasets, ConfigLoader
...
def run(
    ...
    profile_training(train_config, tr_dl, val_dl, model, profile_mode=profile_mode)
